...
```
go get github.com/jamesrr39/genny
```
...
We have started building a [library of common things](https://github.com/jamesrr39/gennylib), and you can use `genny get` to generate the specific versions you need.
...
To see a real example of how to use `genny` with `go generate`, look in the [example/go-generate directory](https://github.com/jamesrr39/genny/tree/master/examples/go-generate).
...
Given [this generic Go code](https://github.com/jamesrr39/genny/tree/master/examples/queue) which compiles and is tested:
...
Check out the [test code files](https://github.com/jamesrr39/genny/tree/master/parse/test) for more real examples.
...
### Contributions
  ...
  * See the [API documentation for the parse package](http://godoc.org/github.com/jamesrr39/genny/parse)
  * Please do TDD
  * All input welcome
